...
const Footer = () => {
  return (
    <footer className="mt-16 border-t border-white/10 bg-gradient-to-b from-primary via-[#090d25] to-[#050713]">
        ...
        <div className="grid gap-8 md:grid-cols-3 items-start">
          <div className="space-y-2">
            ...
            <p className="text-sm text-neutral-300 max-w-md">
              Open to internships and collaborations that mix clean UI with practical engineering.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-col gap-2 text-sm text-neutral-200">
              ...
              <a
                href="mailto:anasbousrih@gmail.com"
                className="hover:text-emerald-200 transition inline-flex items-center gap-2"
              >
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-neutral-300">
              Louisville, KY · Open to internships and remote-friendly roles.
            </p>
            <a
              href="mailto:anasbousrih@gmail.com"
